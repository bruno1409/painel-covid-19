        ...
        <main className="container my-3">
            <div className="card">
                <div className="card-body texto">
                    ...
                    <p>Os dados são obtidos através de uma fonte pública de dados, disponível <a href="https://covid19-brazil-api-docs.vercel.app/" target="_blank">aqui</a>.</p>
            ...
            <code><p className="text-center mt-3"><i className="fas fa-code fa-fw"></i> Versão 1.0 | <i className="fas fa-calendar fa-fw"></i> 03 de junho de 2021</p></code>
        </main>
